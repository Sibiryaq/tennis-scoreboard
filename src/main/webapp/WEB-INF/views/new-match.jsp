    ...
    <div class="container">
        ...
        <div class="form-container center">
            ...
            <form method="post" action="${pageContext.request.contextPath}/new-match">
                ...
                <input class="input-player" name="player1" value="${player1}" placeholder="Name" required>

                <label class="label-player">Player two</label>
                <input class="input-player" name="player2" value="${player2}" placeholder="Name" required>
